...
func init() {
	m.Register(func(app core.App) error {
		...
		collection, err := app.FindCollectionByNameOrId("pbc_755806345")
		if err != nil {
			return err
		}
